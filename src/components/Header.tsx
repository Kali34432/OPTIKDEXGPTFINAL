...
export default function Header({ activeTab, setActiveTab }: HeaderProps) {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    { id: 'wallet-dashboard', label: 'Wallet Dashboard', icon: Wallet, type: 'internal' },
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* OPTIK Wallet Button */}
              <button
                onClick={handleOptikWalletClick}
                className="px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg hover:shadow-purple-500/25"
              >
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 border border-blue-500/30"
              >
            ...
            <div className="absolute right-4 top-16 w-80 bg-gray-800/95 backdrop-blur-md border border-cyan-700/30 rounded-xl shadow-2xl z-50 lg:w-72">
              <div className="p-4">
                ...
                <div className="mt-6 pt-4 border-t border-cyan-700/30">
                  <h4 className="text-sm font-medium text-gray-400 mb-3">Wallet Actions</h4>
                  <div className="space-y-2">
                    <button
                      onClick={handleOptikWalletClick}
                      className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-2 px-3 rounded-lg text-sm font-medium transition-all duration-200 flex items-center space-x-2"
                    >
                      <Wallet className="w-4 h-4" />
      ...
      {/* OPTIK Wallet Modal */}
      {showOptikWallet && (
        <OptikWallet open={showOptikWallet} onClose={() => setShowOptikWallet(false)} />
      )}
